...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout.addWidget(self.add_employee, 1)
        ...
        self.horizontalLayout.addWidget(self.delete_employee, 1)
        ...
        self.month_selector = QtWidgets.QComboBox(self.gridLayoutWidget_4)
        font = QtGui.QFont()
        font.setFamily("Lucida Bright")
        font.setPointSize(12)
        self.month_selector.setFont(font)
        self.month_selector.setObjectName("month_selector")
        self.horizontalLayout_5.addWidget(self.month_selector, 0)
        self.send_attendance = QtWidgets.QPushButton(self.gridLayoutWidget_4)
        font = QtGui.QFont()
        font.setFamily("Lucida Bright")
        font.setPointSize(14)
        self.send_attendance.setFont(font)
        self.send_attendance.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.send_attendance.setObjectName("send_attendance")
        self.send_attendance.clicked.connect(self.send_attendance_email)
        self.horizontalLayout_5.addWidget(self.send_attendance, 0)
        self.gridLayout_4.addLayout(self.horizontalLayout_5, 11, 0, 1, 1)
        ...
        self.horizontalLayout_3.addWidget(self.admin_logout)
        self.gridLayout_4.addLayout(self.horizontalLayout_3, 15, 0, 1, 1)
        self.label_11 = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.label_11.setText("")
        self.label_11.setObjectName("label_11")
        self.gridLayout_4.addWidget(self.label_11, 13, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_23.setPixmap(QtGui.QPixmap("label.png"))
        ...
        self.send_attendance.setText(_translate("MainWindow", "Send Attendance"))
        for month in getMonthNames():
    ...
    def take_attendance_clicked(self):
        attendanceThread = threading.Thread(target=takeattendance)
    ...
    def add_employee_in_xl(self):
        ...
        elif picture == "" or picture == "Upload":
    ...
    def send_attendance_email(self):
        ...
        self.error_dialog.setIcon(QtWidgets.QMessageBox.Information)
        self.error_dialog.setText("Sending email...")
        self.error_dialog.exec_()
